function best_solution = solve()
    ...
    best_solution = sa.run(initial_solution, @sphere_function);
    ...
    best_solution = sa.run(initial_solution, @ackley_function);
    ...
    best_solution = sa.run(initial_solution, @griewank_function);
    ...
    best_solution = sa.run(initial_solution, @rastrigin_function);
    ...
    best_solution = sa.run(initial_solution, @rosenbrock_function);
